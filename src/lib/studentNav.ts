import { BookOpen, Code, FileText, GraduationCap, type LucideIcon } from "lucide-react";

export type StudentNavModule = "lessons" | "materials" | "quiz" | "tests" | "codelab";
...
export const studentNavOrder: StudentNavModule[] = ["lessons", "materials", "quiz", "tests", "codelab"];

export const studentDefaultModules: StudentNavModule[] = ["lessons", "materials", "quiz", "tests"];
